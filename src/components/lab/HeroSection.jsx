        ...
        >
          <div className="mb-6">
            <a href="https://engineering.dartmouth.edu/" target="_blank" rel="noopener noreferrer">
              {/* Vertical logo for mobile */}
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69a06131335d4d0b4fc95ea9/092b440db_white-dartmouth-engineering-vertical-logo.png"
                alt="Dartmouth Engineering"
                className="h-16 w-auto mx-auto opacity-70 hover:opacity-90 transition-opacity sm:hidden"
              />
